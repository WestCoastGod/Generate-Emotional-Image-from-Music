...
def generate_emotion_image(v, a, save_path=r"C:\Users\cxoox\Desktop\GAN\image.png"):
    ...
    G.load_state_dict(
        torch.load(r"C:\Users\cxoox\Desktop\GAN\Weights\generator_final.pth")
    )
    G.eval()
...
# 示例：生成"愉悦且平静"的图像 (V=0.8, A=0.3)
generate_emotion_image(v=0.8, a=0.3, save_path=r"C:\Users\cxoox\Desktop\GAN\image.png")
